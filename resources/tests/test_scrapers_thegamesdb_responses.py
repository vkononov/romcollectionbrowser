...
class Test_GamesDBScraper(unittest.TestCase):
    ...
    def test_retrieve(self):
        ...
        responses.add(responses.GET,
                      'https://api.thegamesdb.net/v1/Games/Images?apikey=TgdbUnitTestApiKey012345678901234567890123456789012345678901234567890&games_id=2613',
    ...
    def test_retrieve_missing_properties(self):
        ...
        responses.add(responses.GET,
                      'https://api.thegamesdb.net/v1/Games/ByGameName?filter%5Bplatform%5D=4911&apikey=TgdbUnitTestApiKey012345678901234567890123456789012345678901234567890&include=boxart&name=Arkanoid&fields=id%2Cgame_title%2Crelease_date%2Cdevelopers%2Cpublishers%2Cplayers%2Cgenres%2Coverview%2Crating',
        ...
        responses.add(responses.GET,
                      ...
                      json=self._loadJsonFromFile('publishers.json'), status=200)
        responses.add(responses.GET,
                      'https://api.thegamesdb.net/v1/Games/Images?apikey=TgdbUnitTestApiKey012345678901234567890123456789012345678901234567890&games_id=9580',
    ...
    def test_retrieve_multiple_genres(self):
        ...
        responses.add(responses.GET,
                      'https://api.thegamesdb.net/v1/Games/ByGameName?filter%5Bplatform%5D=10&apikey=TgdbUnitTestApiKey012345678901234567890123456789012345678901234567890&include=boxart&name=Syphon+Filter&fields=id%2Cgame_title%2Crelease_date%2Cdevelopers%2Cpublishers%2Cplayers%2Cgenres%2Coverview%2Crating',
        ...
        responses.add(responses.GET,
                      ...
                      json=self._loadJsonFromFile('publishers.json'), status=200)
        responses.add(responses.GET,
                      'https://api.thegamesdb.net/v1/Games/Images?apikey=TgdbUnitTestApiKey012345678901234567890123456789012345678901234567890&games_id=7808',
    ...
    def test_search_no_results(self):
        """Make sure that games with multiple genres are handled correctly"""
        responses.add(responses.GET,
                      'https://api.thegamesdb.net/v1/Games/ByGameName?filter%5Bplatform%5D=10&apikey=TgdbUnitTestApiKey012345678901234567890123456789012345678901234567890&include=boxart&name=No+Game+Found&fields=id%2Cgame_title%2Crelease_date%2Cdevelopers%2Cpublishers%2Cplayers%2Cgenres%2Coverview%2Crating',
